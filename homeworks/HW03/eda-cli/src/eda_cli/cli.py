...
def report(
    ...
    title: str = typer.Option("EDA-отчёт", help="Название отчёта о качестве данных."),
    top_k: int = typer.Option(5, help="Топ K категорий по категориальным признакам.")
) -> None:
    """
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Есть дубликаты в признаке-идентификаторе: **{quality_flags['has_id_duplicates']}**\n\n")
